...
function Icon({ type }){
  ...
  if(type === 'settings') return <svg {...common}><circle cx="12" cy="12" r="3.5"/><path d="M12 2.8v2.2M12 19v2.2M4.7 4.7l1.6 1.6M17.7 17.7l1.6 1.6M2.8 12h2.2M19 12h2.2M4.7 19.3l1.6-1.6M17.7 6.3l1.6-1.6"/></svg>
...
export default function SidebarAccountClient(){
  ...
  return <>
    ...
    <Link className="nav" href="/settings"><span className="nav-icon"><Icon type="settings"/></span>Настройки</Link>
