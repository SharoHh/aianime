...
export default function KodikPlayerClient({
  ...
  return <div className="native-kodik-shell native-kodik-v65-light native-kodik-v66-options-fixed native-kodik-v67-episode-numbers native-kodik-v70-clean-iframe" data-aianime-player-ui="v70-clean-iframe">
