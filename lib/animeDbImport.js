...
export function normalizeExternalAnimeForDb(row, { source = 'jikan', titleRu = '' } = {}){
  ...
  return stripUndefined({
    ...
    description_ru: cleanString(row.description_ru) || makeRussianDescription({ title: normalizedTitleRu || title, original_title: originalTitle, genres, kind, status, year, episodes }),
    status,
    kind,
    year,
    episodes,
