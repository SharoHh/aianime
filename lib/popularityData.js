// AIanime v123: real popularity scoring from user actions with short runtime cache.
...
export function decorateAnimeWithPopularity(list, popularityMap){
  ...
  return list.map((item, index) => {
    ...
    return {
      ...
      livePopularityLabel: stat?.totalActions ? `${stat.totalActions} действий` : 'набирает интерес'
    }
  })
}
