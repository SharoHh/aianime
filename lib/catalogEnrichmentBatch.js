...
import {
  ...
  hasUsableAnimePoster,
  posterCandidatesFromAnimeRow,
...
function isPlaceholderPoster(value){
  return isQualityPlaceholderPoster(value)
}

function embeddedPosterCandidates(row = {}){
  return posterCandidatesFromAnimeRow(row)
}
